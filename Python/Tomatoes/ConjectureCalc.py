...
def variabibbles():
    max1, max2, max3 = float(input(f"Input your maximum value for bucket 1 of {conj1}: ")), float(input(f"Input your maximum value for bucket 2 of {conj1}: ")), float(input(f"Input your maximum value for bucket 1 of {conj1}: "))
